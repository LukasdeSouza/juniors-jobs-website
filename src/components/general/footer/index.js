...
import './style.css'
import imgTeamMember from "../../assets/foto-footer-menbro-equipe.svg"
...
const TeamMember = ({ memberOffice, memberGitHubLink = '', img = '', alt = 'Foto do membro da equipe' }) => {
    return (
